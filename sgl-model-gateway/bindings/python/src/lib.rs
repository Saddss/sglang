    ...
    pub fn to_router_config(&self) -> config::ConfigResult<config::RouterConfig> {
        ...
        let convert_policy = |policy: &PolicyType| -> ConfigPolicyConfig {
            match policy {
                ...
                PolicyType::TruncationAware => ConfigPolicyConfig::TruncationAware {
...
impl Router {
    ...
    #[pyo3(signature = (
        ...
        trunc_ewma_window_secs = 60,
        trunc_tick_secs = 30,
        trunc_cooldown_secs = 300,
        trunc_sticky_min = 1,
        trunc_deadband = 0,
        trunc_pressure_ratio = 4.0,
        max_idle_secs = 14400,
    ...
    fn new(
        ...
        Ok(Router {
            ...
            max_tree_size,
            trunc_ewma_window_secs,
            trunc_tick_secs,
            trunc_cooldown_secs,
            trunc_sticky_min,
            trunc_deadband,
            trunc_pressure_ratio,
            max_idle_secs,
            assignment_mode,
            max_payload_size,
            dp_aware,
